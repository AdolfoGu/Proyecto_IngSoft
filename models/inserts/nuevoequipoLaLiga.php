...
<head>
    ...
    <title>Nueva Equipo LaLiga</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-md-7">
                <img  src="../../images/LaLiga.png" class="thumbnail" width="800" height="600">
            </div>

            <form action="../../controllers/inserts/inserteequipoLaLiga.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
