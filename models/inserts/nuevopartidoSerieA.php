...
<head>
    ...
    <title>Nuevo Partido SerieA</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <form action="../../controllers/inserts/insertpartidoSerieA.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="col-md-5">
                    ...
                    <div class="col-sm-10">
                        <select name="local" class="form-control form-control-sm">
                             <?php 
                                ...
                                $consulta="SELECT * FROM equipos WHERE liga ='SerieA'";
                ...
                Guardar</button>
                <a href="../../views/administrador/PartidosSerieA.php"><button type='button' class='btn btn-danger'>
