...
<head>
    ...
    <title>Nuevo Equipo Premier League</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
        <div class="panel-heading"style="white: black; font-weight:bold; font-size:35px;padding: 0px 80px;">
            Nuevo Equipo Premier League
        </div>

    <div class="panel-body">
        <div class="row">
            <div class="col-md-7">
                <img  src="../../images/Premier.png" class="thumbnail" width="800" height="600">
            </div>

            <form action="../../controllers/inserts/inserteequipoPremier.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                Guardar</button>
                <a href="../../views/administrador/Premierleague.php"><button type='button' class='btn btn-danger'>
