...
<head>
    ...
    <title>Nuevo Partido Bundesliga</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <form action="../../controllers/inserts/insertpartidoBundes.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="col-md-5">
                    ...
                    <div class="col-sm-10">
                        <select name="local" class="form-control form-control-sm">
                             <?php 
                                ...
                                $consulta="SELECT * FROM equipos WHERE liga ='Bundesliga'";
...
>>>>>>> d50bf4a57c41c327e22c6f94b2017e38e18eef64
                ...
                Guardar</button>
                <a href="../../views/administrador/PartidosBundes.php"><button type='button' class='btn btn-danger'>
