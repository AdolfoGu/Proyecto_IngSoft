...
<head>
    ...
    <title>Nueva Equipo Liga BBVA</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
        <div class="panel-heading"style="white: black; font-weight:bold; font-size:35px;padding: 0px 80px;">
           Nuevo Equipo Liga BBVA
        </div>

    <div class="panel-body">
        <div class="row">
            <div class="col-md-7">
                <img  src="../../images/Guardianes2020.png" class="thumbnail" width="800" height="600">
            </div>

            <form action="../../controllers/inserts/insertequipoBBVA.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                Guardar</button>
                <a href="../../views/administrador/LigaBBVA.php"><button type='button' class='btn btn-danger'>
