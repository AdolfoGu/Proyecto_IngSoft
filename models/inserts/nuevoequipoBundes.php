...
<head>
    ...
    <title>Nueva Equipo Bundesliga</title>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
        <div class="panel-heading"style="white: black; font-weight:bold; font-size:35px;padding: 0px 80px;">
            Nueva Equipo Bundesliga
        </div>

    <div class="panel-body">
        <div class="row">
            <div class="col-md-7">
                <img  src="../../images/Bundesliga.png" class="thumbnail" width="800" height="600">
            </div>

            <form action="../../controllers/inserts/insertequipoBundes.php" class="form-horizontal" method="POST" enctype="multipart/form-data">
                ...
                Guardar</button>
                <a href="../../views/administrador/Bundesliga.php"><button type='button' class='btn btn-danger'>
