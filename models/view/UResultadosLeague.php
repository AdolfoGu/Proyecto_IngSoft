...
<nav class="menu">
        ...
        <ul class="menu_items">
            ...
            <li class="active"><a href="">Premier League</a>
                <ul class="submenu">
                    <li><a href="../../views/usuario/ResultadoSerieA.php">SerieA</a></li>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM resultados WHERE liga ='Premier League' AND jornada ='".$jornada."'";
                ...
                <a href="../../views/usuario/ResultadoLeague.php">
