        ...
        <ul class="menu_items">
            ...
            <li class="active"><a href="">Bundesliga</a>
                <ul class="submenu">
                    ...
                    <li><a href="../../views/usuario/ResultadoBBVA.php">SerieA</a></li>
                </ul>
            </li>
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM resultados WHERE liga ='Bundesliga' AND jornada ='".$jornada."'";
                ...
                <a href="../../views/usuario/ResultadoBundes.php">
