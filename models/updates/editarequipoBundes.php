...
<head>
    ...
    <title>Editar Equipo Bundesliga</title>
</head>
<body>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateequipoBundes.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
