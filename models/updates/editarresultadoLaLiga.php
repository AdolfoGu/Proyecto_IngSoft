...
<head>
    ...
    <title>Editar Resultado LaLiga </title>
</head>
<body>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateresultadoLaLiga.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
                ...
                Guardar</button>
                <a href="../../views/administrador/ResultadoLaLiga.php"><button type='button' class='btn btn-danger'>
