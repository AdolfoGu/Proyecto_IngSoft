...
<head>
    ...
    <title>Editar Resultado Bundesliga</title>
</head>
<body>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateresultadoBundes.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
                ...
                Guardar</button>
                <a href="../../views/administrador/ResultadoBundes.php"><button type='button' class='btn btn-danger'>
