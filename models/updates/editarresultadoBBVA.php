...
<head>
    ...
    <title>Ediar Resultado Liga BBVA</title>
</head>
<body>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateresultadoBBVA.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
                ...
                Guardar</button>
                <a href="../../views/administrador/ResultadoBBVA.php"><button type='button' class='btn btn-danger'>
