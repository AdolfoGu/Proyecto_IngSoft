...
<head>
    ...
    <title>Ediar Resultado Premierleague</title>
</head>
<body>
...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
        <div class="panel-heading" style="white: black; font-weight:bold; font-size:35px;padding: 0px 80px;">
            Editar Resultado Premierleague
        </div>
</div>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateresultadoLeague.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
                ...
                Guardar</button>
                <a href="../../views/administrador/ResultadoLeague.php"><button type='button' class='btn btn-danger'>
