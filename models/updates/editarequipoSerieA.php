...
<head>
    ...
    <title>Editar Equipo SerieA</title>
</head>
<body>
...
<div class="panel-body">
    <div class="row">
        ...
        <form action="../../controllers/updates/updateequipoSerieA.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
            <div class="col-md-5">
