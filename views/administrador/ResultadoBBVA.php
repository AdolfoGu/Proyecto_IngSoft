            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=1'><button type='button' class='btn btn-warning'> 
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=2'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=3'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=4'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=5'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=6'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=7'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=8'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=9'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=10'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=11'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=12'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=13'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=14'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=15'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=16'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
                   ...
                   <tr class= "efecto">
                        ...
                        <?php
                        echo "<td>
                            <a href='../../models/view/ResultadosBBVA.php?jornada=17'><button type='button' class='btn btn-warning'> 
                                <svg xmlns='http://www.w3.org/2000/svg'width='16' height='16' fill='currentColor' class='bi bi-eye-fill' viewBox='0 0 16 16'>
                                    <path d='M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z'/><path d='M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z'/>
                                </svg>
                            </button></a>
