                ...
                <table class="table">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th scope="col"></th>
                            <th scope="col"><a href="../../models/inserts/nuevopartidoBBVA.php"><button type="button" class="btn btn-info">
                    ...
                    <?php
                        ...
                        while($filas=mysqli_fetch_assoc($resultado)){
                            ...
                            echo'<tr class= "efecto">';
                                ...
                                echo'<td>';echo'</td>';
                                echo "<td> <a href='../../controllers/deletes/deletepartidoBBVA.php?id=".$filas['id_partido']."''><button type='button' class='btn btn-danger'>
