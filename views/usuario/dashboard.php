...
<div class="panel panel-primary"  align="center" style="padding:1.5%">
    ...
    <div class="jumbotron">
      ...
      <h1>¡Bienvenido <?php echo $_SESSION['usuario']?>!</h1>
        <p>Nos alegra tenerte de vuelta, reviza los proximos partidos,
            resultados y tablas generales.
        </p>
      </div>
    </div>

  
       <h2> Lideres del Momento </h2>
       <h3>Liga BBVA</h3>
       <table class="table">
                    ...
                    <?php
                        ...
                        $query = "SELECT * FROM equipos WHERE liga = '".$liga."' ORDER BY puntos_totales DESC LIMIT 1";
