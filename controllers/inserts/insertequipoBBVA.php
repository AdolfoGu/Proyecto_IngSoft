<?php
	...
	function NuevoEquipo($file1,$abreviatura,$nombre,$jg,$jp,$je,$jj,$gf,$gc,$puntos,$liga)
	{
		...
		$sentencia="INSERT INTO equipos (logo, abreviatura, nombre_equipo, juegos_ganados, juegos_perdidos, juegos_empatados, juegos_jugados, goles_favor, goles_contra, puntos_totales, liga) 
...
<script type="text/javascript">
	...
	window.location.href='../../views/administrador/LigaBBVA.php';
</script>