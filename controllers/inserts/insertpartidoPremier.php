<?php
	...
	function NuevoPartido($local,$visitante,$fecha,$hora,$jornada)
	{
        ...
        VALUES ('".$local."', '".$visitante."', 'Premier League', '".$fecha."' , '".$hora."', '".$jornada."')";
		 ...
		 VALUES ('".$local."', '".$visitante."', 'Premier League', NULL , NULL, '".$jornada."')";
		  $conexion = mysqli_connect("localhost", "root", "", "futbol");
...
<script type="text/javascript">
	...
	window.location.href='../../views/administrador/PartidosPremier.php';
</script>